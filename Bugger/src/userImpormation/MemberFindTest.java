		...
		getContentPane().setLayout(new BorderLayout());
		{
			...
			panel.setLayout(card);
			{
				...
				panel_1.setLayout(new BorderLayout(0, 0));
				{
					...
					{
						JLabel logID = new JLabel("");
						logID.setBackground(Color.WHITE);
						logID.setIcon(new ImageIcon(MemberFindTest.class.getResource("/img/id_img.png")));
						panel_2.add(logID);
					...
					{
						JLabel logPasswd = new JLabel("");
						logPasswd.setBackground(Color.WHITE);
						logPasswd.setIcon(new ImageIcon(MemberFindTest.class.getResource("/img/pwd_img.png")));

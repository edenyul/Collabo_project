...
/*	public static void main(String[] args) {
	...
	public OrderSetSide() {
		...
		lblnull7.setForeground(Color.ORANGE);
		lblnull7.setBackground(Color.ORANGE);
		...
		JLabel label = new JLabel("\uC0AC\uC774\uB4DC \uBA54\uB274");
	...
	public void mouseClicked(java.awt.event.MouseEvent e) {
		...
		//음료
		String[] sBeverage= {"(S)콜라L","(S)콜라R","(S)사이다L","(S)사이다R","(S)환타 오렌지L","(S)환타 오렌지R","(S)아메리카노","(S)아이스 아메리카노","(S)핫초코",""};
		int[] iBeverage= {500, 0, 500, 0, 500, 0, 500, 500, 500, 0};
